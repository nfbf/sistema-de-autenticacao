...
public class LoginView {
	...
	public static String viewLogin() {
		...
		while (!resultado) {
			...
			if ((login.equalsIgnoreCase(Messages.ADMIN)|| login.equalsIgnoreCase(Messages.EMAIL_ADMIN)) && retorno.equalsIgnoreCase(Messages.PASSWORD_MUST_BE_RESET)) {
			...
			}  else if (retorno.equalsIgnoreCase(Messages.USERNAME_BLOQUEADO) || retorno.equalsIgnoreCase(Messages.USER_NOT_FOUND)) {
				System.err.println("\n\n" + retorno);
				resultado = true;
